...
class SOCAL(Dataset):
    def __init__(self, 
                 ...
                 frame_res=224,
                 downsample_fac=1,
                 images_dir='/home/jmackey/scratch/CJRepo/socal/JPEGImages/', 
                 frame_to_trial_path='/home/jmackey/scratch/CJRepo/socal/frame_to_trial_mapping.csv',
                 outcomes_path='/home/jmackey/scratch/CJRepo/socal/socal_trial_outcomes.csv'):
        
        self.train = train
        self.downsample_fac = downsample_fac
        self.images_dir = images_dir # folder containing individual frames
        self.frame_to_trial = pd.read_csv(frame_to_trial_path) # frame to trial csv
        self.outcomes = pd.read_csv(outcomes_path) # outcomes csv
